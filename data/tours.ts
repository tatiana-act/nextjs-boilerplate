...
export const tours: TourProgram[] = [
    ...
    },
    {
        ...
        description: 'Завораживающая прогулка по центру города, наполненная тайнами и загадками, мистическими легендами и завораживающими рассказами о призраках',
        duration: '2 часа',
        price: 30,
        imageUrl: '/haust.jpg',
        highlights: [
    ...
    {
        id: 'Auhnry',
        title: 'Историческая прогулка по центру Остина с посещением музея О\'Генри',
    ...
    },
    {
        ...
        description: 'Проведите увлекательные выходные в стиле Остин! ' +
