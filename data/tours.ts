...
export const tours: TourProgram[] = [
    ...
    {
        id: 'Auhnry',
        title: 'Историческая прогулка по Конгресс-авеню с посещением дома-музея О\'Генри',
        shortTitle: 'тур Остину+музей О\'Генри',
        ...
        highlights: [
            ...
            'Вы узнаете писателя О\'Генри с необычной стороны',
